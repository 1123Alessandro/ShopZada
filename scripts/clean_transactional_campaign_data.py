...
df_transactional_campaign = pd.read_csv('./Project Dataset/Marketing Department/transactional_campaign_data.csv')
...
df_transactional_campaign.to_parquet('./exports/clean_transactional_campaign_data.parquet')
